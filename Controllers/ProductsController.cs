...
namespace GeorgianConnects.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(LavishComputersContext context)
        {
            _context = context;
        }
        ...
        {
            var lavishComputersContext = _context.Product.Include(p => p.Category);
            return View(await lavishComputersContext.ToListAsync());
        }
